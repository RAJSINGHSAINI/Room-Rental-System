...
async function addHome(e) {
    ...
    try {
        const response = await fetch("/api/home/add-home", {
            method: "POST",
            body: formData,
            credentials: "include"
        });
...
<div class="home-image">
    <img src="/uploads/${home.coverImage}" alt="Home Image">
...
async function getRooms() {
    ...
    const response = await fetch("/api/home/get-homes", {
        method: "GET",
        credentials: "include"
    })
...
async function delHome(homeId) {
    ...
    modal.querySelector('.delete-btn').onclick = async () => {
        try {
            const delResponse = await fetch(`/api/home/del-home/${homeId}`, {
                method: "DELETE",
                credentials: "include"
            });
...
async function loadAllBookedRooms() {
    ...
    const bookedResponse = await fetch('/api/booking/get-owner-home-bookings', {
        method: 'GET',
        credentials: 'include'
    })
            ...
            <div class=" home-card rented-room">
                    <div class="wrap-up">
                        ...
                        <div class="cover-image">
                            <img src="/uploads/${home.coverImage}" alt="">
                        </div>
